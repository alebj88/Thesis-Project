...
#Importamos la tabla procesada por Proyecto.R junto con las demas
#Usaremos MatBio1 para agregarle la informacio climatologica al resto.

#Dataset principal
MatBio1 <- read.csv(
"~/Thesis Project AB/Data/Processed Data/FactorsTransect_BenthicSubstrate_ProcMan2_proc1.csv")
...
write.csv(MatBio2,file = "FactorsTransect_GreatGroups_ProcMan2_Proc1.csv",
          row.names = FALSE)
write.csv(MatBio3,file = "FactorsTransect_SCLEGrowth_ProcMan2_Proc1.csv",
          row.names = FALSE)
write.csv(MatBio4,file = "FactorsTransect_SCLESpecies_ProcMan2_Proc1.csv",
          row.names = FALSE)
