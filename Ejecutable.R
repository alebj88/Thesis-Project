...
if (!dir.exists("Thesis Project AB")){
    ...
    file.move(path1,path2)
    path1 <- paste0(from,"DataCoralesProcMan2_Const.R")
    path2 <- paste0(to,"DataCoralesProcMan2_Const.R")
    file.move(path1,path2)
    path1 <- paste0(from,"TablasDeShiny.txt")
    path2 <- paste0(to,"TablasDeShiny.txt")
    file.move(path1,path2)
