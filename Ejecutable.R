...
if (!dir.exists("Thesis Project AB")){
    ...
    file.move(path1,path2)
    path1 <- paste0(from,"DataCoralesProcMan.csv")
    path2 <- paste0(to,"DataCoralesProcMan.csv")
    file.move(path1,path2)
    #Limpiando memoria
    ...
    #Procesamiento de datos de la aplicacion de Shiny 1.
    #cat("Ejecutando el 'Processing-Shiny1.R' para el procesamiento de los datos \n") 
    #cat("de la aplicacion.\n")
    #cat("\n")
    #source("Processing-Shiny1.R")
