...
interpretador<-function(arch){
    ...
    nombres<-c("n0","n1","n2","n3","n4","n5","n6","n7","n8","n9","mns","pt")
...
procesamientoDeImagenes<-function(imagPNG){
    #imagPNG <-"MonthlyandSeasonalAverages3.png"
    img <-readPNG(imagPNG)
    ...
    if(identical(as.numeric(dim(img)),c(708,1124,4)) == FALSE){
        stop("ERROR: El archivo PNG no posee la dimension adecuada.
              Posible zona de geolocalizacion incorrecta.")
    }
    ...
    png(file=paste0("MAPA",imagPNG))
    plot(c(1,1124),c(1,867),type='n',main=paste0("MAPA",imagPNG))
    ...
    setwd("~/Thesis Project/Data/Raw Data/Giovanni/Ctrl")
    png(file=paste0("colorBAND",imagPNG))
    plot(c(1,1124),c(1,867),type='n',main=paste0("colorBAND",imagPNG))         
    ...
    setwd("~/Thesis Project/Data/Raw Data/Giovanni/Ctrl")
    png(file=paste0("colSUP",imagPNG))
    plot(c(1,1124),c(1,867),type='n',main=paste0("colSUP",imagPNG))         
    ...
    setwd("~/Thesis Project/Data/Raw Data/Giovanni/Ctrl")
    png(file=paste0("colCEN",imagPNG))
    plot(c(1,1124),c(1,867),type='n',main=paste0("colCEN",imagPNG))         
    ...
    setwd("~/Thesis Project/Data/Raw Data/Giovanni/Ctrl")
    png(file=paste0("colINF",imagPNG))
    plot(c(1,1124),c(1,867),type='n',main=paste0("colINF",imagPNG))         
    ...
    setwd("~/Thesis Project/Data/Raw Data/Giovanni/Ctrl")
    png(file=paste0("NRO",imagPNG))
    plot(c(1,1124),c(1,867),type='n',main=paste0("NRO",imagPNG))         
