...
cariaco$silicate2.UMOLperKG<-uMolperL*(1/1.027)           #uMolperL a UMOLperKG.
cariaco$silica.uM<-NULL

# uMolperL<-as.numeric(cariaco$nitrate.uM)      
# cariaco$nitrate2.UMOLperKG<-uMolperL*(1/1.027)          #uMolperL a UMOLperKG.
# cariaco$nitrate.uM<-NULL

# uMolperL<-as.numeric(cariaco$nitrite.uM)
# cariaco$nitrite2.UMOLperKG<-uMolperL*(1/1.027)          #uMolperL a UMOLperKG.
# cariaco$nitrite.uM<-NULL

# uMolperL<-as.numeric(cariaco$ammonia.uM)
# cariaco$ammonia.UMOLperKG<-uMolperL*(1/1.027)           #uMolperL a UMOLperKG.
# cariaco$ammonia.uM<-NULL

uMolperL<-as.numeric(cariaco$phosphate2.UMOLperLiter)  #Asumimos que son iguales
cariaco$phosphate2.UMOLperKG<-uMolperL*(1/1.027)          #uMolperL a UMOLperKG.
cariaco$phosphate2.UMOLperLiter<-NULL

# uMolperL<-as.numeric(cariaco$ammonium.UMOLperLiter)
# cariaco$ammonium2.UMOLperKG<-uMolperL*(1/1.027)           #uMolperL a UMOLperKG.
# cariaco$ammonium.UMOLperLiter<-NULL

# uMolperL<-as.numeric(cariaco$nitrate2.UMOLperLiter) #REVISAAAAR
# cariaco$nitrate2.2.UMOLperKG<-uMolperL*(1/1.027)        #uMolperL a UMOLperKG.
# cariaco$nitrate2.UMOLperLiter<-NULL

# uMolperL<-as.numeric(cariaco$nitrite2.UMOLperLiter)
# cariaco$nitrite2.2.UMOLperKG<-uMolperL*(1/1.027)        #uMolperL a UMOLperKG.
...
world<-world[-72 <= world$longitude,]
