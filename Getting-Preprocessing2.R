...
#Creando clave para merge con corrientes
cariaco$clave2<-paste(as.character(cariaco$date),cariaco$latitude,
                      cariaco$longitude,sep=" ")
...
corrientes$clave2<-paste(as.character(corrientes$date),corrientes$latitude,
                         corrientes$longitude,sep=" ")
...
data<-spread(world,key=medida,value=value)
