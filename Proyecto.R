...
#REGION PREDEFINIDA ////////////////////////
#Copiar y pegar -73,8,-60,17 en el recuadro "select region" de la pagina.
#https://giovanni.gsfc.nasa.gov/giovanni/ para descargar mapas de la zona
#predeterminada
...
#Si alternativo == FALSE el vector Margen_Map no se considera.
Margen_Map <-c(-73,11,-60,20)        
