...
if (!dir.exists("Thesis Project AB")){
    ...
    file.remove("~/Thesis Project AB/Union por Geolocalizacion/Datos Finales/BorrarEsto.txt")	
    file.remove("~/Thesis Project AB/Union por Geolocalizacion/Biologicas/BorrarEsto.txt")	
    file.remove("~/Thesis Project AB/Union por Geolocalizacion/Ambientales/BorrarEsto.txt")	
    file.remove("~/Thesis Project AB/Procesador de Mapas/Mapas/Ctrl/BorrarEsto.txt")
    file.remove("~/Thesis Project AB/Procesador de Mapas/Mapas/BorrarEsto.txt")	
    file.remove("~/Thesis Project AB/Procesador de Mapas/Datos Finales/BorrarEsto.txt")	
