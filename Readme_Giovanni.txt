...
datos alternativos" donde aparecen dos variables, "alternativo" y "mapCenter". Solo cuando 
"alternativo" recibe el valor TRUE, el punto de geolocalizacion latitud - longitud ingresado
en mapCenter como vector se considera. Tal punto de geolocalizacion representara el centro del
nuevo mapa que se desea procesar y este debe ser calculado por el usuario. En la primera 
posicion se coloca el punto medio del rango de latitudes del mapa y en la segunda posicion
el punto medio de las longitudes del mapa. 

Por ejemplo mapCenter <- c(12.5,-66.5) le indica al programa que el mapa esta centrado en el 
punto de latitud 12.5 grados, longitud -66.5 grados.
