...
write.csv(clave,"clavesExtra1.csv",row.names = F)
...
write.csv(clave,"clavesExtra2.csv",row.names = F)
...
write.csv(clave,"clavesExtra3.csv",row.names = F)
...
write.csv(clave,"clavesExtra4.csv",row.names = F)
