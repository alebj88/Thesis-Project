...
shinyServer(function(input,output){
    ...
    # #Numero de componentes a usar.
    # output$RUi_Select_C.EvalNMDS <- renderUI({
    #     #Input
    #     pco <- NMDSReact()
    #     
    #     #Check de entrada.
    ...
    #     maximo <- dim(unclass(pco$loadings))[2]
    #     
    #     numericInput("Select_C.EvalNMDS","Número de Componentes a Usar:",
    #                  min = 1,max = maximo,value = 2,step = 1)
    #     
    # })
    # 
