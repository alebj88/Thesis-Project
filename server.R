...
shinyServer(function(input,output){
    ...
    #---------------------------------------------------------------------------
    #INPUT: VARIABLE A EXPLICAR. 
    # => (input$Select_Zvar)
    #output$RUi_Select_Zvar
    ...
    #---------------------------------------------------------------------------
    #INPUT: CORRIENTES VARIABLE EXPLORATORIA 1.
    # => (input$Select_CorrY)
    ...
    #---------------------------------------------------------------------------
    #INPUT: DISTANCIA VARIABLE EXPLORATORIA 1.
    # => (input$Select_DistY)
    ...
    #---------------------------------------------------------------------------
    #INPUT: CORRIENTES VARIABLE EXPLORATORIA 2.
    # => (input$Select_CorrX)
    ...
    #---------------------------------------------------------------------------
    #INPUT: DISTANCIA VARIABLE EXPLORATORIA 2.
    # => (input$Select_DistX)
    ...
    output$RPlot_Scat <- renderPlot({
        ...
        #Correccion rapida del input de etiqueta.
        if(is.null(Etiq)){
            Etiq <- TRUE
        }
    ...
    output$RUi_checkboxGroup3.Zvar <- renderUI({
        ...
        #Se habilita cuando la variable ingresada es numerica.
        }else{
            df <- dfReact()
            Zvar <- input$Select_Zvar
            #Removemos null.
