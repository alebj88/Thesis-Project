                         ...
                         tabPanel("Diagrama de Cajas",br(),
                            navlistPanel(widths = c(2, 10),
                                tabPanel("Boxplot por Localidad",
                                    ...
                                    ,
                                    splitLayout( 
                                        uiOutput("RUi_LegendBoxLoc")
                                        ,
                                        br()
                                        ,
                                        #Boton de action.
                                        actionButton("goButtonBox",
                                                     "Submit Plot",
                                                     icon("paper-plane"),
                                                     style = "color: white; 
                                                     background: #35e51d")
                         ...
                         tabPanel("Histogramas",br(),
                            navlistPanel(widths = c(2, 10),
                                tabPanel("Histograma por Localidad",
                                    ...
                                    ,
                                    splitLayout( 
                                        uiOutput("RUi_LegendHistLoc")
                                        ,
                                        br()
                                        ,
                                        #Boton de action.
                                        actionButton("goButtonHis",
                                                     "Submit Plot",
                                                     icon("paper-plane"),
                                                     style = "color: white; 
                                                     background: #35e51d")
